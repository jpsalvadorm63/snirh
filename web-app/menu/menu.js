...
jQuery(function() {
    ...
    if (!($.browser.msie && $.browser.version < 7)){
        $('ul ul a', '#menu').css({background: 'none'}).hover(
            function(){ $(this).css({backgroundColor: 'rgb(0,81,97)'}).animate({backgroundColor: 'rgb(0,103,130)'}, 500); },
            function(){ $(this).animate({backgroundColor: 'rgb(0,81,97)'}, {duration : 300, complete : function(){
