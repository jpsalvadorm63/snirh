...
<html>
  ...
  <div class="crud" style="width:700px;margin-left: auto; margin-right: auto;">
        ...
        <g:if test="${usuarioInstance?.institucion}">
          <li class="fieldcontain">
            <span id="mail-label" class="property-label"><g:message code="usuario.institucion.label" default="Institución" /></span>

            <span class="property-value" aria-labelledby="institucion-label"><g:fieldValue bean="${usuarioInstance}" field="institucion"/></span>

          </li>
        </g:if>

        <g:if test="${usuarioInstance?.descripcion}">
          <li class="fieldcontain">
            <span id="mail-label" class="property-label"><g:message code="usuario.descripcion.label" default="Descripción" /></span>

            <span class="property-value" aria-labelledby="descripcion-label"><g:fieldValue bean="${usuarioInstance}" field="descripcion"/></span>
