...
<html>
	...
	<body>
		<a href="#create-estadistica" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <div class="crud" style="width:700px;margin-left: auto; margin-right: auto;">
		<div id="create-estadistica" class="content scaffold-create" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${estadisticaInstance}" var="error">
