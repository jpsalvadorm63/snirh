...
<html>
	...
	<body>
		<a href="#edit-tipoEstacion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
  ...
  <div class="crud" style="width:700px;margin-left: auto; margin-right: auto;">
		<div id="edit-tipoEstacion" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="[entityName]" /></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${tipoEstacionInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${tipoEstacionInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${tipoEstacionInstance?.version}" />
				<fieldset class="form">
