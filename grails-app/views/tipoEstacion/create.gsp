...
<html>
	...
	<body>
		<a href="#create-tipoEstacion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <div class="crud" style="width:700px;margin-left: auto; margin-right: auto;">
		<div id="create-tipoEstacion" class="content scaffold-create" role="main">
