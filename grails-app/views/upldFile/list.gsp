...
<div id="menu">
  <ul class="menu">
    <li><a class="home" href="${createLink(uri: '/')}"><span><g:message code="default.home.label"/></span></a></li>
    <!-- <li><a href="#" class="parent"><span>Plantillas</span></a>
      <div>
        <ul>
          <li><g:link controller="upldFile" action="generateXls"><span>Mensuales/año</span></g:link></li>
        </ul>
      </div>
    </li> -->
  </ul>
  ...
  <div id="list-upldFile" class="content scaffold-list" role="main">
    ...
    <table>
      ...
      <tr>
        ...
        <sec:access expression="hasRole('ROLE_DATALOADER')"><th>Borrar</th></sec:access>
      </tr>
      </thead>
      <tbody>
