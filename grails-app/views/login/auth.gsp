...
<head>
    ...
    border-radius: 12px;
    background:#f5f5f5 url(${resource(dir: 'images', file: 'empresa.png')}) no-repeat center 8px;
...
<div id='login' >
  <div class='inner' >
		...
		<div style="text-align:center;font-size:16px;font-weight:bolder;margin: 104px 0 16px 0">Ingreso al sistema</div>
